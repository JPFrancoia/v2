	...
	if user.Password != "" {
		...
		query := `
			UPDATE users SET
				...
				stylesheet=$14,
				custom_js=$15,
				external_font_hosts=$16,
				google_id=$17,
				openid_connect_id=$18,
				display_mode=$19,
				entry_order=$20,
				default_reading_speed=$21,
				cjk_reading_speed=$22,
				default_home_page=$23,
				categories_sorting_order=$24,
				mark_read_on_view=$25,
				mark_read_on_media_player_completion=$26,
				media_playback_rate=$27,
				block_filter_entry_rules=$28,
				keep_filter_entry_rules=$29,
				always_open_external_links=$30,
				open_external_links_in_new_tab=$31,
				show_voting_buttons=$32
			WHERE
				id=$33
		`
