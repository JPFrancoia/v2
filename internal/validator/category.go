...
func ValidateCategoryCreation(ctx context.Context, store *storage.Storage, userID int64, request *model.CategoryCreationRequest) *locale.LocalizedError {
	if request.Title == "" {
...
func ValidateCategoryModification(ctx context.Context, store *storage.Storage, userID, categoryID int64, request *model.CategoryModificationRequest) *locale.LocalizedError {
